...
export async function apiRequest(path, options = {}) {
  ...
  try {
    ...
    // fetch() itself throws (network down, DNS failure) before any HTTP response exists - the
    // runtime's own message here is English and would otherwise leak past every caller's
    // `err.message || <Vietnamese fallback>` pattern.
